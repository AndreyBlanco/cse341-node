...
const getDisabilities = async(req, res, next) => {
...
const updateDisability = async (req, res) => {
    ...
    const result2 = await mongodb.getDb().db().collection('disabilities').replaceOne({_id: userId}, newInfo);
...
const deleteDisability = async (req, res) => {
    ...
    const result3 = await mongodb.getDb().db().collection('disabilities').deleteOne({_id: userId}, true);
...
module.exports = {getDisabilities, getOneDisability, addDisability, updateDisability, deleteDisability};